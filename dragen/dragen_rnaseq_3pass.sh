...
project_dir=/staging/2021-10-04_rnaseq_fusions

# pass 1
if [ ! -f ${project_dir}/dragen_${sample}/pass1/$sample.SJ.out.tab ]; then

dragen \
--output-directory ${project_dir}/dragen_${sample}/pass1 \
-r /staging/reference/genomes/Hsapiens/hg19 \
--output-file-prefix $sample \
-1 ${project_dir}/input/${sample}_1.fq.gz \
-2 ${project_dir}/input/${sample}_2.fq.gz \
--enable-rna true \
...
dragen \
--output-directory ${project_dir}/dragen_${sample}/pass2 \
-r /staging/reference/genomes/Hsapiens/hg19 \
--output-file-prefix $sample \
-1 ${project_dir}/input/${sample}_1.fq.gz \
-2 ${project_dir}/input/${sample}_2.fq.gz \
--enable-rna true \
--annotation-file ${project_dir}/dragen_${sample}/pass1/$sample.SJ.out.tab \
...
dragen \
--output-directory ${project_dir}/dragen_${sample}/pass3 \
-r /staging/reference/genomes/Hsapiens/hg19 \
--output-file-prefix $sample \
