...
# CLNSIG is a tuple for some reason
...
vembrane filter 'any(clnrevstat=="reviewed_by_expert_panel" or clnrevstat=="criteria_provided,_multiple_submitters,_no_conflicts" for clnrevstat in INFO["CLNREVSTAT"])' clinvar.pathogenic.vcf.gz > clinvar.selected.vcf
